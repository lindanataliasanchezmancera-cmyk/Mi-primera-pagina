...
También aprendimos que el almacenamiento digital funciona con esta misma idea. Toda la información, ya sean datos, programas o archivos, se guarda usando combinaciones de unos y ceros que forman los llamados bytes. Estos bytes son como pequeñas piezas que, al juntarse, permiten almacenar enormes cantidades de información en dispositivos modernos como los discos SSD, que son rápidos y muy compactos.

Otro tema importante fueron los lenguajes de programación. Estos son los medios que usamos para comunicarnos con las computadoras, ya que ellas no entienden nuestro idioma. Los lenguajes nos permiten darles instrucciones paso a paso para que realicen tareas, basándose en esa misma lógica binaria.

Además, exploramos plataformas digitales que nos permiten trabajar con otras personas sin importar dónde estemos, siempre que tengamos conexión a internet. Gracias a estas herramientas, es posible colaborar en tiempo real y crear o editar proyectos de manera conjunta.
...
mensaje = f"¡Hola, {nombre}! Espero que tengas un excelente día 😊"
print(mensaje)
```
